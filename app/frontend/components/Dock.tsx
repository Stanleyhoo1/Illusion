...
export default function Dock({
  ...
  return (
    <motion.div
      ...
      className={`${className} fixed bottom-2 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-2 pb-2 px-4 z-50`}
