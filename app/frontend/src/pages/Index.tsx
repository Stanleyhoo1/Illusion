...
const Index = () => {
  ...
  const thinkingSteps = useMemo(
    () => [
      "Locating official privacy, terms of service, and data-usage pages…",
      "Checking for regional variants of privacy policies…",
      "Resolving redirects and validating source domains…",
      "Collecting policy URLs and metadata…",
      "Fetching documents and preparing them for analysis…",
      "Extracting readable text from policy pages…",
      "Removing boilerplate and non-relevant sections…",
      "Identifying key clauses related to data collection…",
      "Identifying how your data is used across products…",
      "Detecting data-sharing practices with third parties…",
      "Analyzing cookie usage and tracking technologies…",
      "Evaluating retention timelines for user data…",
      "Checking for user privacy controls and deletion options…",
      "Reviewing API-specific data practices…",
      "Extracting safety, compliance, and legal obligations…",
      "Classifying findings into strengths, risks, and unknowns…",
      "Comparing practices to typical industry standards…",
      "Assessing clarity and transparency of disclosures…",
      "Scoring transparency and risk levels…",
      "Generating citations linked to each extracted fact…",
      "Validating extracted points for consistency…",
      "Aggregating extracted insights into structured categories…",
      "Checking for missing or contradictory policy statements…",
      "Summarizing high-level practices and obligations…",
      "Drafting user protection recommendations…",
      "Formatting the final transparency summary…",
      "Refining clarity of explanations…",
      "Preparing model reasoning and trace logs…",
      "Finalizing your structured privacy report…"
    ],
    []
  );
